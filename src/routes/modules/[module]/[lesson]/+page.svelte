<script lang="ts">
	...
	import { lessonOgImage } from '$lib/seo';
...
<Seo title="{lesson.meta.title} · {module.meta.title} · {course.title}" description={lesson.meta.description}
	image={lessonOgImage(module.slug, lesson.slug)}
	type="article"
/>
